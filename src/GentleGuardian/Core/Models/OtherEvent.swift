...
/// Represents a user-defined "other" event for tracking any custom activity.
struct OtherEvent: Identifiable, Codable, Sendable, Equatable {
    ...
    /// User-defined name for this activity (e.g., "Massage", "Music class").
    var name: String
    ...
    /// A human-readable summary of this other event.
    var summary: String {
